...
pub static BLOG_NAME: &str = "Example name";                      // blog name showed in titles and main page

pub static BLOG_DESCRIPTION: &str = "Example blog description";   // blog description showed in main page
